...
# -*-coding:utf-8 -*-
'''
@File    :   validation_qfield.py
@Time    :   2022/07/06 16:25:77
...
@Desc    :   pyQGIS script for validating position of points from Qfield survey
'''
...
#Steps:
#-----------------
#0. Clean the current map view and set up the environment for the validation
...
uri = "" #<--- Insert data path file for the traffic signals collected with Qfield
...
extent = segnali.extent()
canvas.setExtent(extent)    
pts_fields = segnali.fields()
pts_feats = segnali.getFeatures()
#-----------------
#3. Load road layer
uri0 ="" #<--- Insert data path file for the streets of the Provincia di Piacenza
...
uri1 = "" #<--- Insert data path file for the administrative boundaries of the Provincia di Piacenza
admin=iface.addVectorLayer(uri1,"comuni","ogr")
#-----------------
#5. Define buffer layer
#Creating buffer at 5 meters
outFile = 'C:/Users/Admin/Desktop/CS_Piacenza/CSV_Validation/buffer.shp'
bufDist = 5  # buffer width in map units
